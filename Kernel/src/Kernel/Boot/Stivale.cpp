...
namespace Kernel
{
	...
	{
		auto* current_tag = reinterpret_cast<stivale2_tag*>(bootloader_data->tags + AK::s_physical_memory_offset);
		while (true)
		{
			...
			current_tag = reinterpret_cast<stivale2_tag*>(current_tag->next + AK::s_physical_memory_offset);
		}
	}
}
